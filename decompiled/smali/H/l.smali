...
.method public static X(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, LH/l;->Z(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, LH/l;->Z(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static Y([LM/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
...
.method public final n(Landroid/content/Context;LG/f;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p2, p4}, LH/l;->X(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final o(Landroid/content/Context;[LM/i;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p1}, LH/l;->Y([LM/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p1, p3}, LH/l;->X(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final p(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    .locals 5
    ...
    invoke-static {v0, p1}, LH/l;->Y([LM/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {v4, p1}, LH/l;->Y([LM/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0, p3}, LH/l;->X(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final q(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    .locals 0
...
.method public final u([LM/i;I)LM/i;
    .locals 0
