...
.method public constructor <init>(Landroid/text/PrecomputedText$Params;)V
    ...
    invoke-static {p1}, LM1/f;->k(Landroid/text/PrecomputedText$Params;)Landroid/text/TextPaint;

    move-result-object v0

    iput-object v0, p0, LN/c;->a:Landroid/text/TextPaint;

    invoke-static {p1}, LM1/f;->j(Landroid/text/PrecomputedText$Params;)Landroid/text/TextDirectionHeuristic;

    move-result-object v0

    iput-object v0, p0, LN/c;->b:Landroid/text/TextDirectionHeuristic;

    invoke-static {p1}, LM1/f;->b(Landroid/text/PrecomputedText$Params;)I

    move-result v0

    iput v0, p0, LN/c;->c:I

    invoke-static {p1}, LM1/f;->y(Landroid/text/PrecomputedText$Params;)I
...
.method public constructor <init>(Landroid/text/TextPaint;Landroid/text/TextDirectionHeuristic;II)V
    ...
    invoke-static {p1}, LM1/f;->i(Landroid/text/TextPaint;)Landroid/text/PrecomputedText$Params$Builder;

    move-result-object v0

    invoke-static {v0, p3}, LM1/f;->g(Landroid/text/PrecomputedText$Params$Builder;I)Landroid/text/PrecomputedText$Params$Builder;

    move-result-object v0

    invoke-static {v0, p4}, LM1/f;->z(Landroid/text/PrecomputedText$Params$Builder;I)Landroid/text/PrecomputedText$Params$Builder;

    move-result-object v0

    invoke-static {v0, p2}, LM1/f;->h(Landroid/text/PrecomputedText$Params$Builder;Landroid/text/TextDirectionHeuristic;)Landroid/text/PrecomputedText$Params$Builder;

    move-result-object v0

    invoke-static {v0}, LM1/f;->u(Landroid/text/PrecomputedText$Params$Builder;)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    :cond_3
    iget-object v0, p0, LN/c;->a:Landroid/text/TextPaint;

    invoke-virtual {v0}, Landroid/graphics/Paint;->getTextSize()F

    move-result v1

    iget-object v2, p1, LN/c;->a:Landroid/text/TextPaint;
...
.method public final hashCode()I
    ...
    iget-object v10, p0, LN/c;->b:Landroid/text/TextDirectionHeuristic;
...
.method public final toString()Ljava/lang/String;
    ...
    invoke-static {v2}, LG0/a;->i(Landroid/text/TextPaint;)Ljava/lang/String;
