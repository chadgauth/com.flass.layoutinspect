...
.field public static volatile h:LR0/x;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LR0/x;->g:Ljava/io/File;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LR0/x;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a()LR0/x;
    .locals 2

    sget-object v0, LR0/x;->h:LR0/x;

    if-nez v0, :cond_1

    const-class v0, LR0/x;

    monitor-enter v0

    :try_start_0
    sget-object v1, LR0/x;->h:LR0/x;

    if-nez v1, :cond_0

    new-instance v1, LR0/x;

    invoke-direct {v1}, LR0/x;-><init>()V

    sput-object v1, LR0/x;->h:LR0/x;
...
.method public final c(IIZZ)Z
    ...
    :cond_1
    sget-boolean p3, LR0/x;->e:Z

    if-eqz p3, :cond_2

    iget-object p3, p0, LR0/x;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput v1, p0, LR0/x;->b:I

    sget-object p2, LR0/x;->g:Ljava/io/File;
