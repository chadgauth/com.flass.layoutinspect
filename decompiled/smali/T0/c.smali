...
.method public final bridge synthetic b(Ljava/lang/Object;IILI0/i;)LK0/C;
    .locals 0

    check-cast p1, Landroid/net/Uri;

    invoke-virtual {p0, p1, p4}, LT0/c;->c(Landroid/net/Uri;LI0/i;)LK0/C;
...
.method public final c(Landroid/net/Uri;LI0/i;)LK0/C;
    .locals 8
    ...
    sget-object p1, LT0/c;->b:LI0/h;

    invoke-virtual {p2, p1}, LI0/i;->c(LI0/h;)Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v5, v0}, Lcom/bumptech/glide/c;->p(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_5
    invoke-static {v1, v1, v5, p1}, Lcom/bumptech/glide/c;->p(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, p1, p2}, LT0/b;-><init>(Landroid/graphics/drawable/Drawable;I)V
