...
.method static constructor <clinit>()V
    ...
    sput-object v0, LW/b;->o:LV0/a;

    new-instance v0, LV0/a;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, LW/b;->p:LV0/a;
...
# virtual methods
.method public final b(Landroid/view/View;)LA2/b;
    .locals 0
...
.method public final d(Landroid/view/View;LQ/f;)V
    ...
    iget-object p1, p1, LB1/d;->q:Lcom/google/android/material/chip/Chip;

    iget-object v1, p1, Lcom/google/android/material/chip/Chip;->e:LB1/f;

    if-eqz v1, :cond_0

    iget-boolean v1, v1, LB1/f;->a0:Z
    ...
    invoke-virtual {p2, v0}, LQ/f;->h(Ljava/lang/CharSequence;)V
...
.method public final j(I)Z
    ...
    invoke-virtual {p0, p1, v1}, LW/b;->p(IZ)V

    const/16 v0, 0x8

    invoke-virtual {p0, p1, v0}, LW/b;->r(II)V
...
.method public final k(I)LQ/f;
    ...
    invoke-direct {v1, v0}, LQ/f;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-virtual {v1, v3}, LQ/f;->h(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p1, v1}, LW/b;->o(ILQ/f;)V

    invoke-virtual {v1}, LQ/f;->f()Ljava/lang/CharSequence;
    ...
    iget-object v6, p0, LW/b;->d:Landroid/graphics/Rect;
    ...
    invoke-virtual {v1, v8}, LQ/f;->a(I)V
    ...
    invoke-virtual {v1, v7}, LQ/f;->a(I)V
    ...
    invoke-virtual {v1, v2}, LQ/f;->a(I)V
    ...
    iget-object p1, v1, LQ/f;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public final m(ILandroid/graphics/Rect;)Z
    ...
    invoke-direct {v4, v5}, Ls/n;-><init>(I)V
    ...
    invoke-virtual {v0, v7}, LW/b;->k(I)LQ/f;
    ...
    invoke-virtual {v4, v8, v7}, Ls/n;->d(ILjava/lang/Object;)V
    ...
    :cond_1
    invoke-virtual {v4, v3}, Ls/n;->b(I)Ljava/lang/Object;
    ...
    :goto_1
    sget-object v8, LW/b;->o:LV0/a;

    sget-object v9, LW/b;->p:LV0/a;
    ...
    invoke-virtual {v0, v5}, LW/b;->n(I)LQ/f;

    move-result-object v2

    iget-object v2, v2, LQ/f;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-virtual {v4, v9}, Ls/n;->f(I)Ljava/lang/Object;
    ...
    iget-object v12, v11, LQ/f;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    invoke-virtual {v12, v6}, Landroid/view/accessibility/AccessibilityNodeInfo;->getBoundsInScreen(Landroid/graphics/Rect;)V

    invoke-static {v1, v13, v6}, LO2/g;->I(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_f
    invoke-static {v1, v13, v2}, LO2/g;->I(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_10
    invoke-static {v1, v13, v6, v2}, LO2/g;->f(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_11
    invoke-static {v1, v13, v2, v6}, LO2/g;->f(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_12
    invoke-static {v1, v13, v6}, LO2/g;->P(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v12

    invoke-static {v1, v13, v6}, LO2/g;->S(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {v1, v13, v2}, LO2/g;->P(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v12

    invoke-static {v1, v13, v2}, LO2/g;->S(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-virtual {v4, v10}, Ls/n;->f(I)Ljava/lang/Object;
    ...
    invoke-direct {v6, v5, v8}, LW/c;-><init>(ZLV0/a;)V
    ...
    :cond_1d
    iget-boolean v3, v4, Ls/n;->a:Z

    if-eqz v3, :cond_1e

    invoke-static {v4}, Ls/j;->a(Ls/n;)V
    ...
    iget-object v6, v4, Ls/n;->c:[Ljava/lang/Object;
    ...
    :goto_12
    invoke-virtual {v4, v12}, Ls/n;->c(I)I

    move-result v7

    :goto_13
    invoke-virtual {v0, v7}, LW/b;->q(I)Z
...
.method public final n(I)LQ/f;
    ...
    iget-object v5, v1, LQ/f;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_3
    invoke-virtual {p0, p1}, LW/b;->k(I)LQ/f;
...
.method public abstract o(ILQ/f;)V
.end method
...
.method public final q(I)Z
    ...
    invoke-virtual {p0, p1, v0}, LW/b;->p(IZ)V

    const/16 v1, 0x8

    invoke-virtual {p0, p1, v1}, LW/b;->r(II)V
...
.method public final r(II)V
    ...
    invoke-virtual {p0, p1}, LW/b;->n(I)LQ/f;
    ...
    invoke-virtual {v2}, LQ/f;->f()Ljava/lang/CharSequence;
