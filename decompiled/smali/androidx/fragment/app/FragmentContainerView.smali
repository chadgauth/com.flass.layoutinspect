...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Ld0/K;)V
    .locals 6
    ...
    invoke-virtual {p3, v2}, Ld0/K;->A(I)Ld0/s;
    ...
    invoke-static {p3, v1, p1}, LH/e;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {p3}, Ld0/K;->D()Ld0/D;

    move-result-object v5

    invoke-virtual {p1}, Landroid/content/Context;->getClassLoader()Ljava/lang/ClassLoader;

    invoke-virtual {v5, v1}, Ld0/D;->a(Ljava/lang/String;)Ld0/s;
    ...
    iput v2, v1, Ld0/s;->w:I

    iput v2, v1, Ld0/s;->x:I

    iput-object v4, v1, Ld0/s;->y:Ljava/lang/String;

    iput-object p3, v1, Ld0/s;->s:Ld0/K;

    iget-object v2, p3, Ld0/K;->u:Ld0/u;

    iput-object v2, v1, Ld0/s;->t:Ld0/u;

    const/4 v2, 0x0

    invoke-virtual {v1, p1, p2, v2}, Ld0/s;->y(Landroid/content/Context;Landroid/util/AttributeSet;Landroid/os/Bundle;)V

    new-instance p1, Ld0/a;

    invoke-direct {p1, p3}, Ld0/a;-><init>(Ld0/K;)V

    iput-boolean v0, p1, Ld0/a;->p:Z

    iput-object p0, v1, Ld0/s;->E:Landroid/view/ViewGroup;

    invoke-virtual {p0}, Landroid/view/View;->getId()I

    move-result p2

    invoke-virtual {p1, p2, v1, v4, v0}, Ld0/a;->e(ILd0/s;Ljava/lang/String;I)V

    iget-boolean p2, p1, Ld0/a;->g:Z

    if-nez p2, :cond_5

    iput-boolean v3, p1, Ld0/a;->h:Z

    iget-object p2, p1, Ld0/a;->q:Ld0/K;

    iget-object v1, p2, Ld0/K;->u:Ld0/u;

    if-eqz v1, :cond_6

    iget-boolean v1, p2, Ld0/K;->H:Z
    ...
    :cond_3
    invoke-virtual {p2, v0}, Ld0/K;->w(Z)V

    iget-object v0, p2, Ld0/K;->J:Ljava/util/ArrayList;

    iget-object v1, p2, Ld0/K;->K:Ljava/util/ArrayList;

    invoke-virtual {p1, v0, v1}, Ld0/a;->a(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z

    const/4 p1, 0x1

    iput-boolean p1, p2, Ld0/K;->b:Z

    :try_start_0
    iget-object p1, p2, Ld0/K;->J:Ljava/util/ArrayList;

    iget-object v0, p2, Ld0/K;->K:Ljava/util/ArrayList;

    invoke-virtual {p2, p1, v0}, Ld0/K;->S(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p2}, Ld0/K;->d()V

    invoke-virtual {p2}, Ld0/K;->d0()V

    iget-boolean p1, p2, Ld0/K;->I:Z

    if-eqz p1, :cond_4

    const/4 p1, 0x0

    iput-boolean p1, p2, Ld0/K;->I:Z

    invoke-virtual {p2}, Ld0/K;->b0()V

    :cond_4
    iget-object p1, p2, Ld0/K;->c:LA0/x;
    ...
    :cond_6
    :goto_1
    iget-object p1, p3, Ld0/K;->c:LA0/x;

    invoke-virtual {p1}, LA0/x;->j()Ljava/util/ArrayList;
    ...
    iput-object p0, v0, Ld0/s;->E:Landroid/view/ViewGroup;

    invoke-virtual {p3}, Ld0/Q;->b()V
...
.method public final dispatchApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {v0, p1}, LP/t0;->g(Landroid/view/View;Landroid/view/WindowInsets;)LP/t0;
    ...
    invoke-static {v0, v1}, LP/t0;->g(Landroid/view/View;Landroid/view/WindowInsets;)LP/t0;
    ...
    invoke-virtual {v1}, LP/t0;->f()Landroid/view/WindowInsets;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-static {p0, v0}, LP/D;->b(Landroid/view/View;Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p0, v2}, LP/t0;->g(Landroid/view/View;Landroid/view/WindowInsets;)LP/t0;
    ...
    invoke-static {v3, v0}, LP/N;->b(Landroid/view/View;LP/t0;)V
...
.method public final getFragment()Ld0/s;
    ...
    iget-object v0, v2, Ld0/s;->t:Ld0/u;

    if-eqz v0, :cond_4

    iget-boolean v0, v2, Ld0/s;->k:Z
    ...
    iget-object v0, v1, Lh/i;->s:La0/h;
    ...
    invoke-virtual {v0, v1}, Ld0/K;->A(I)Ld0/s;
