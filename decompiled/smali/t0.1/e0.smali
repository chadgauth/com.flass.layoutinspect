...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Lt0/e0;->g:Landroidx/recyclerview/widget/RecyclerView;

    sget-object v0, Landroidx/recyclerview/widget/RecyclerView;->A0:LW/d;

    iput-object v0, p0, Lt0/e0;->d:Landroid/view/animation/Interpolator;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lt0/e0;->e:Z

    iput-boolean v1, p0, Lt0/e0;->f:Z
    ...
    iput-object v1, p0, Lt0/e0;->c:Landroid/widget/OverScroller;
...
.method public final a()V
    ...
    :cond_0
    iget-object v0, p0, Lt0/e0;->g:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final b(IIILandroid/view/animation/Interpolator;)V
    ...
    iget-object v2, p0, Lt0/e0;->g:Landroidx/recyclerview/widget/RecyclerView;
    ...
    sget-object p4, Landroidx/recyclerview/widget/RecyclerView;->A0:LW/d;

    :cond_4
    iget-object p3, p0, Lt0/e0;->d:Landroid/view/animation/Interpolator;

    if-eq p3, p4, :cond_5

    iput-object p4, p0, Lt0/e0;->d:Landroid/view/animation/Interpolator;
    ...
    iput-object p3, p0, Lt0/e0;->c:Landroid/widget/OverScroller;

    :cond_5
    iput v1, p0, Lt0/e0;->b:I

    iput v1, p0, Lt0/e0;->a:I

    const/4 p3, 0x2

    invoke-virtual {v2, p3}, Landroidx/recyclerview/widget/RecyclerView;->setScrollState(I)V

    iget-object v3, p0, Lt0/e0;->c:Landroid/widget/OverScroller;
...
.method public final run()V
    ...
    iget-object v0, p0, Lt0/e0;->c:Landroid/widget/OverScroller;
    ...
    iput-boolean v9, p0, Lt0/e0;->f:Z

    const/4 v10, 0x1

    iput-boolean v10, p0, Lt0/e0;->e:Z

    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView;->m()V

    iget-object v11, p0, Lt0/e0;->c:Landroid/widget/OverScroller;
    ...
    iget v3, p0, Lt0/e0;->a:I

    sub-int v3, v1, v3

    iget v4, p0, Lt0/e0;->b:I

    sub-int v4, v2, v4

    iput v1, p0, Lt0/e0;->a:I

    iput v2, p0, Lt0/e0;->b:I
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/RecyclerView;->m:Lt0/P;

    iget-object v5, v5, Lt0/P;->e:Lt0/B;

    if-eqz v5, :cond_6

    iget-boolean v6, v5, Lt0/B;->d:Z

    if-nez v6, :cond_6

    iget-boolean v6, v5, Lt0/B;->e:Z

    if-eqz v6, :cond_6

    iget-object v6, v0, Landroidx/recyclerview/widget/RecyclerView;->f0:Lt0/c0;

    invoke-virtual {v6}, Lt0/c0;->b()I

    move-result v6

    if-nez v6, :cond_3

    invoke-virtual {v5}, Lt0/B;->i()V

    goto :goto_1

    :cond_3
    iget v7, v5, Lt0/B;->a:I

    if-lt v7, v6, :cond_4

    sub-int/2addr v6, v10

    iput v6, v5, Lt0/B;->a:I

    invoke-virtual {v5, v1, v2}, Lt0/B;->g(II)V
    ...
    iget-object v6, v6, Lt0/P;->e:Lt0/B;

    if-eqz v6, :cond_10

    iget-boolean v6, v6, Lt0/B;->d:Z
    ...
    :cond_1a
    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView;->e0:Lr1/g;
    ...
    iget-object v3, v0, Landroidx/recyclerview/widget/RecyclerView;->d0:Lt0/t;

    if-eqz v3, :cond_1d

    invoke-virtual {v3, v0, v1, v2}, Lt0/t;->a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-boolean v2, v1, Lt0/B;->d:Z

    if-eqz v2, :cond_1e

    invoke-virtual {v1, v9, v9}, Lt0/B;->g(II)V

    :cond_1e
    iput-boolean v9, p0, Lt0/e0;->e:Z

    iget-boolean v1, p0, Lt0/e0;->f:Z
